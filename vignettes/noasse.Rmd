---
title: "noaase Vignette"
author: "Lukasz Krainski"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{noaase Vignette}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

`noaase` is the R package developed to clean and visualize data from the ["NOAA Significant Earthquake Database"](https://www.ngdc.noaa.gov/nndc/struts/form?t=101650&s=1&d=1).
...
Clean the data using `eq_clean_data` function (use `eq_location_clean` in processing).
